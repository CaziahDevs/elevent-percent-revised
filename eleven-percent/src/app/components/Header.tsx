...
export default function Header() {
  return (
    <header className=" bg-[#d2af85] p-5 px-7 rounded-md sticky top-0 max-w-[1000px] mx-auto w-f flex items-center justify-between ">
      ...
      <nav className="flex gap-5 *:py-2 *:px-4 *:rounded-md">
        ...
        <Link href='/visuals' className="bg-blue-600 text-white transition ease-in-out hover:bg-sky-800">Visualization</Link>
      </nav>
    </header>
  );
}